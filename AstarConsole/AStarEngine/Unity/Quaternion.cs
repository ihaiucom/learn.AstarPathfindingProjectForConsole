...
public struct Quaternion
{
    ...
    private static extern void INTERNAL_CALL_AngleAxis(float angle, ref Vector3 axis, out Quaternion quaternion);
    ...
    [DllImport("TestDLL.dll")]
    private static extern void INTERNAL_CALL_FromToRotation(ref Vector3 fromDirection, ref Vector3 toDirection, out Quaternion quaternion);
    ...
    [DllImport("TestDLL.dll")]
    private static extern void INTERNAL_CALL_LookRotation(ref Vector3 forward, ref Vector3 upwards, out Quaternion quaternion);
    [ExcludeFromDocs]
    ...
    [DllImport("TestDLL.dll")]
    private static extern void INTERNAL_CALL_Slerp(ref Quaternion a, ref Quaternion b, float t, out Quaternion quaternion);
    ...
    [DllImport("TestDLL.dll")]
    private static extern void INTERNAL_CALL_SlerpUnclamped(ref Quaternion a, ref Quaternion b, float t, out Quaternion quaternion);
    ...
    {
        Quaternion quaternion;
         INTERNAL_CALL_Inverse_Quaternion(ref rotation,out quaternion);
        return quaternion;
    }

    [DllImport("TestDLL.dll")]
    private static extern void INTERNAL_CALL_Inverse_Quaternion(ref Quaternion rotation,out Quaternion q);
    ...
    {
        Vector3 vector;
        vector = INTERNAL_CALL_Internal_ToEulerRad(ref rotation);
        return vector;
    }
    ...
    [DllImport("TestDLL.dll")]
    private static extern void INTERNAL_CALL_Internal_FromEulerRad(ref Vector3 euler,out Quaternion q);
    ...
    [DllImport("TestDLL.dll")]
    private static extern void INTERNAL_CALL_AxisAngle(ref Vector3 axis, float angle,out Quaternion q);
    [Obsolete("Use Quaternion.AngleAxis instead. This function was deprecated because it uses radians instead of degrees")]
