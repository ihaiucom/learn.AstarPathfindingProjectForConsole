...
public struct Matrix4x4
{
    ...
    public static Matrix4x4 Inverse(Matrix4x4 m)
    {
        Matrix4x4 matrixx;
      long l=  dlltest();
        matrixx = INTERNAL_CALL_Inverse(ref m);
    ...
    public bool isIdentity
    {
        get
        {
            ...
            if (m00 == 1f && m01 == 0f && m02 == 0f && m03 == 0f && m10 == 0f && m11 == 1f && m12 == 0f && m13 == 0f && m20 == 0f && m21 == 0f && m22 == 1f && m23 == 0f && m30 == 0f && m31 == 0f && m32 == 0f && m33 == 1f)
                return true;
            else
                return false;
        }
    ...
    {
        Matrix4x4 matrixx ;
        //return new Matrix4x4 { m00 =1, m01 = 0f, m02 = 0f, m03 = pos.x, m10 = 0f, m11 =1, m12 = 0f, m13 =pos .y , m20 = 0f, m21 = 0f, m22 = 1, m23 =pos.z , m30 = 0f, m31 = 0f, m32 = 0f, m33 = 1f };
        matrixx= INTERNAL_CALL_TRS(ref pos, ref q, ref s);
       // dlltest();
        return matrixx;
    }
